using Evently.Application.Subscriptions.Commands.CancelSubscription;
...
using DomainSubscriptionType = Evently.Domain.Users.SubscriptionType;
using SubscriptionType = Evently.Contracts.Common.SubscriptionType;
